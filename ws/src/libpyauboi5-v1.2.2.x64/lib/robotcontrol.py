...
liblog4cplus = cdll.LoadLibrary('/home/wang/Downloads/代码视频/13,写字案例/写字案例day01/代码/libpyauboi5-v1.2.2.x64/lib/liblog4cplus-1.2.so.5')
libconfig = cdll.LoadLibrary('/home/wang/Downloads/代码视频/13,写字案例/写字案例day01/代码/libpyauboi5-v1.2.2.x64/lib/libconfig.so')
aa = cdll.LoadLibrary('/home/wang/Downloads/代码视频/13,写字案例/写字案例day01/代码/libpyauboi5-v1.2.2.x64/lib/libprotobuf.so.9')
import time
import libpyauboi5
import logging
